...
public class AlbumsFragment extends Fragment implements GetData, OnRefreshListener {
    ...
    public void onResume() {
        ...
        if (username.equals("me"))
            activity.getActionBar().setTitle(String.format(activity.getResources().getString(R.string.activity_title_album_user), username));
        else
            activity.getActionBar().setTitle(R.string.activity_title_my_album);
    }
