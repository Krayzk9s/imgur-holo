...
public class SingleImageFragment extends Fragment implements GetData, OnRefreshListener {
    ...
    public void onResume() {
        ...
        if (activity != null && activity.getActionBar() != null)
            activity.getActionBar().setTitle(R.string.activity_title_image);
    }
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_submit:
                ...
                new AlertDialog.Builder(activity).setTitle("Set Gallery Title/Press OK to remove")
                        .setView(newGalleryTitle).setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
            ...
            case R.id.action_edit:
                try {
                    ...
                    new AlertDialog.Builder(activity).setTitle(R.string.dialog_edit_title)
        ...
        if (tag.equals(REPLY)) {
            ...
            try {
                if (jsonObject.getJSONObject("data").has("error")) {
                    ...
                    fetcher.execute();
                    Toast.makeText(getActivity(), R.string.toast_explanation_comment_submitted, Toast.LENGTH_SHORT).show();
                } else {
                    ...
                    fetcher.execute();
                    Toast.makeText(getActivity(), R.string.toast_explanation_comment_removed, Toast.LENGTH_SHORT).show();
                }
            } catch (JSONException e) {
                Log.e("Error!", e.toString());
            }
            ...
            imageComment.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    new AlertDialog.Builder(activity).setTitle(R.string.dialog_comment_on_image_title)
                            .setView(commentReplyLayout).setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int whichButton) {
