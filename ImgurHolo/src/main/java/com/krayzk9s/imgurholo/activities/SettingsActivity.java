...
public class SettingsActivity extends ImgurHoloActivity {
    ...
    public static class SettingsFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            ListPreference imagesLayout = (ListPreference) findPreference("ImagesLayout");
            imagesLayout.setSummary(imagesLayout.getValue());
            imagesLayout.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
                @Override
                public boolean onPreferenceChange(Preference preference, Object o) {
                    preference.setSummary(o.toString());
                    return true;
